...
export default class DevSecops extends Component {
  render() {
    ...
    return (
      <div>
      <Helmet>
            <title>Scritpics | DevSecops</title>
            <meta name="description" content="DevSecops" />
            <meta name="twitter:card" content="summary_large_image"/>
            <meta name="twitter:site" content="@Scripticstech"/>
            <meta name="twitter:title" content="Scritpics | DevSecops"/>
            <meta name="twitter:description" content="Thinkbox Studio"/>
            <meta name="twitter:creator" content="@Scripticstech"/>
            <meta property="og:type" content="website"/>
            <meta property="og:title" content="Scritpics | DevSecops"/>
            <meta property="og:description" content="Thinkbox Studio"/>
