...
export default class DataStrategy extends Component {
  render() {
    ...
    return (
      <div>
        <Helmet>
            <title>Scritpics | Data Stratergy</title>
            <meta name="description" content="Data Stratergy" />
            <meta name="twitter:card" content="summary_large_image"/>
            <meta name="twitter:site" content="@Scripticstech"/>
            <meta name="twitter:title" content="Scritpics | Data Stratergy"/>
            <meta name="twitter:description" content="Data Statergy"/>
            <meta name="twitter:creator" content="@Scripticstech"/>
            <meta property="og:type" content="website"/>
            <meta property="og:title" content="Scritpics | Data Stratergy"/>
            <meta property="og:description" content="Data Stratergy"/>
