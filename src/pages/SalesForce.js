...
export default class SalesForce extends Component {
  render() {
    ...
    return (
        ...
        <Helmet>
            <title>Scritpics | SalesForce</title>
            <meta name="description" content= "Sales Force" />
            <meta name="twitter:card" content="summary_large_image"/>
                <meta name="twitter:site" content="@Scripticstech"/>
                <meta name="twitter:title" content="Scritpics | Salesforce"/>
                <meta name="twitter:description" content="Scritics Salesforce"/>
                <meta name="twitter:creator" content="@Scripticstech"/>
                <meta property="og:type" content="website"/>
                <meta property="og:title" content="Scritpics | Salesforce"/>
                <meta property="og:description" content="Scriptics Salesforce"/>
